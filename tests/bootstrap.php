<?php
/**
 * WooCommerce_Attach_File_To_Order Test Bootstrapper.
 *
 * @since   0.0.0
 ...
 * @since 0.0.0
 */
function _manually_load_woocommerce_attach_file_to_order_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/woocommerce-attach-file-to-order.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_woocommerce_attach_file_to_order_plugin' );
